<template>
  <div class="align-items-end md:align-items-start flex flex-wrap-reverse md:flex-nowrap justify-content-between">
    <section class="max-w-75">
      <h1 class="typ-header-sm my-3">Image report manager</h1>
